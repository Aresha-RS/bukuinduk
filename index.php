...
<html>
  <head>
	...
	<style>
		 ...
		 .nav-tabs.nav-justified>.dropdown .dropdown-menu{top:auto;left:auto}@media (min-width:768px){
		 .nav-tabs.nav-justified>li{display:table-cell;width:1%}
		 .nav-tabs.nav-justified>li>a{margin-bottom:0}}
		 .nav-tabs.nav-justified>li>a{margin-right:0;border-radius:4px}
		 .nav-tabs.nav-justified>.active>a,
		 .nav-tabs.nav-justified>.active>a:focus,.nav-tabs.nav-justified>.active>a:hover{border:1px solid #ddd}@media (min-width:768px){
		 ...
		 .nav-tabs-justified>li>a{margin-right:0;border-radius:4px}.nav-tabs-justified>.active>a,
		 .nav-tabs-justified>.active>a:focus,
		 .nav-tabs-justified>.active>a:hover{border:1px solid #ddd}@media (min-width:768px){
    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img src="img/foto.png" alt="person" class="img-fluid rounded-circle">
             <h2 class="h5"><?=$nama;?></h2><span><?=$level;?></span>
          </div>
          <!-- Small Brand information, appears on minimized sidebar-->
          <div class="sidenav-header-logo"><a href="index.php?hal=" class="brand-small text-center"> <strong>AB</strong><strong class="text-primary">IS</strong></a></div>
        </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">
            <li <?=getAktif("data_admin");?>><a href="index.php?hal=data_admin"> <i class="icon-user"></i>Admin</a></li>
            <li <?=getAktif("data_siswa");?>><a href="index.php?hal=data_siswa"> <i class="icon-user"></i>Siswa</a></li>
            <li <?=getAktif("data_wakel");?>><a href="index.php?hal=data_wakel"> <i class="icon-user"></i>Wali Kelas</a></li>
            <li <?=getAktif("data_pelajaran");?>><a href="index.php?hal=data_pelajaran"> <i class="icon-interface-windows"></i>Pelajaran</a></li>
            <li <?=getAktif("data_kelas");?>><a href="index.php?hal=data_kelas"> <i class="icon-home"></i>Kelas</a></li>
          </ul>
        </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">
            <li <?=getAktif("data_siswa");?>><a href="index.php?hal=data_siswa"> <i class="icon-user"></i>Siswa</a></li>
            <li <?=getAktif("data_kelas");?>><a href="index.php?hal=data_kelas"> <i class="icon-home"></i>Kelas</a></li>
            <li <?=getAktif("data_pelajaran");?>><a href="index.php?hal=data_pelajaran"> <i class="icon-interface-windows"></i>Pelajaran</a></li>		  </ul>
        </div>
        <div class="Admin-menu">
        ...
        <div class="main-menu">
          <h5 class="sidenav-heading">Master</h5>
          <ul id="side-main-menu" class="side-menu list-unstyled">
            <li <?=getAktif("buku_induk");?>><a href="index.php?hal=buku_induk"> <i class="icon-user"></i>Siswa</a></li>
		  </ul>
        </div>
        <div class="admin-menu">
          <h5 class="sidenav-heading">Pengolahan</h5>
        ...
        <nav class="navbar">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.php?hal=" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><span></span> <strong class="text-primary">Aplikasi Buku Induk Siswa <span class=" text-warning"><?=$th_pelajaran;?></span> </strong></div></a></div>
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <!-- Log out-->
                <li class="nav-item"><a href="logout.php" class="nav-link logout" onclick="return confirm('Anda yakin ingin keluar?')"> <span class="d-none d-sm-inline-block">Logout</span><i class="fa fa-sign-out"></i></a></li>
              </ul>
            </div>
          </div>
        </nav>
      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?=getAddress();?></li>
          </ul>
        </div>
      </div>
      <section>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6  align-text-center">
              <p>Kelompok 2 &copy; <i>Aplikasi Buku Induk Siswa versi 2018</i></p>
            </div>
