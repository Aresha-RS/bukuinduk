					...
					$nama_file = date("Y-m-d")."_data_diri_".$ns;
					header("Content-type: application/vnd-ms-excel");
					header("Content-Disposition: attachment; filename=$nama_file.xls");
					}
					?>
					<br>
					<h4 class="page-header" align="center">LEMBAR BUKU INDUK PESERTA DIDIK SMP</h4>
					<br>
					...
					<tr>
						<td>Dari SMP</td>
						<td><?=$dsiswa['dari_smp'];?></td>
					</tr>
					<tr>
						<td>Alamat</td>
						<td><?=$dsiswa['alamat_smp'];?></td>
					</tr>
					<tr>
