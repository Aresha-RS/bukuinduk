			  <div class="card">
                ...
                <div class="card-body">
					<?php
					$lsiswa = mysql_query("select * from tbsiswa,tbkelas where tbsiswa.id_kelas=tbkelas.id_kelas and tbsiswa.id_siswa = '".$_GET['edit']."'");
					...
					<div class="form-group">
						...
						<input type="reset" class="btn btn-danger" value="Batal"></div>
					</fieldset>
					</form>
				</div>
              </div>